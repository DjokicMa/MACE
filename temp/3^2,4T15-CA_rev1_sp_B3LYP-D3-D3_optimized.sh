#!/bin/bash --login
#SBATCH -J 3^2,4T15-CA_rev1_sp_B3LYP-D3-D3_optimized
#SBATCH -o 3^2,4T15-CA_rev1_sp_B3LYP-D3-D3_optimized-%J.o
...
export JOB=3^2,4T15-CA_rev1_sp_B3LYP-D3-D3_optimized
