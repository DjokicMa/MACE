#!/bin/bash --login
#SBATCH -J 3^6,4T4-CA_rev1_sp_B3LYP-D3-D3_optimized
#SBATCH -o 3^6,4T4-CA_rev1_sp_B3LYP-D3-D3_optimized-%J.o
...
export JOB=3^6,4T4-CA_rev1_sp_B3LYP-D3-D3_optimized
