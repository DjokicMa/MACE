#!/bin/bash --login
#SBATCH -J 3^8,4^2T4-CA_rev1_sp_B3LYP-D3-D3_optimized
#SBATCH -o 3^8,4^2T4-CA_rev1_sp_B3LYP-D3-D3_optimized-%J.o
...
export JOB=3^8,4^2T4-CA_rev1_sp_B3LYP-D3-D3_optimized
