#!/bin/bash --login
#SBATCH -J 1_dia_opt_rev1_sp_B3LYP-D3-D3_optimized
#SBATCH -o 1_dia_opt_rev1_sp_B3LYP-D3-D3_optimized-%J.o
...
export JOB=1_dia_opt_rev1_sp_B3LYP-D3-D3_optimized
