#!/bin/bash --login
#SBATCH -J 4^3T83-CA_SCF_opt_rev1_sp_B3LYP-D3-D3_optimized
#SBATCH -o 4^3T83-CA_SCF_opt_rev1_sp_B3LYP-D3-D3_optimized-%J.o
...
export JOB=4^3T83-CA_SCF_opt_rev1_sp_B3LYP-D3-D3_optimized
