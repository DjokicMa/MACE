#!/bin/bash --login
#SBATCH -J 3_dia3_opt_rev1_sp_B3LYP-D3-D3_optimized
#SBATCH -o 3_dia3_opt_rev1_sp_B3LYP-D3-D3_optimized-%J.o
...
export JOB=3_dia3_opt_rev1_sp_B3LYP-D3-D3_optimized
