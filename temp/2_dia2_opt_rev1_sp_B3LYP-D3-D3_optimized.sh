#!/bin/bash --login
#SBATCH -J 2_dia2_opt_rev1_sp_B3LYP-D3-D3_optimized
#SBATCH -o 2_dia2_opt_rev1_sp_B3LYP-D3-D3_optimized-%J.o
...
export JOB=2_dia2_opt_rev1_sp_B3LYP-D3-D3_optimized
