#!/bin/bash --login
#SBATCH -J 4LG_FSI_2x2_ABAB_opt_HSESOL3C_optimized_charge+potential
#SBATCH -o 4LG_FSI_2x2_ABAB_opt_HSESOL3C_optimized_charge+potential-%J.o
...
#SBATCH -t 7-00:00:00
#SBATCH --mem=80G
export JOB=4LG_FSI_2x2_ABAB_opt_HSESOL3C_optimized_charge+potential
export DIR=$SLURM_SUBMIT_DIR
export scratch=$SCRATCH/crys23/prop/attempt2
...
cp DENS_CUBE.DAT ${DIR}/${JOB}_DENS.CUBE
cp POT_CUBE.DAT ${DIR}/${JOB}_POT.CUBE
cp SPIN_CUBE.DAT ${DIR}/${JOB}_SPIN.CUBE
