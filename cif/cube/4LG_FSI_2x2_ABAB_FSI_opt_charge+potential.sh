#!/bin/bash --login
#SBATCH -J 4LG_FSI_2x2_ABAB_FSI_opt_charge+potential
#SBATCH -o 4LG_FSI_2x2_ABAB_FSI_opt_charge+potential-%J.o
...
#SBATCH -t 2:00:00
#SBATCH --mem=80G
export JOB=4LG_FSI_2x2_ABAB_FSI_opt_charge+potential
