#!/bin/bash --login
#SBATCH -J 4LG_2x2_AA_opt_HSESOL3C_optimized_charge+potential
#SBATCH -o 4LG_2x2_AA_opt_HSESOL3C_optimized_charge+potential-%J.o
...
#SBATCH -t 7-00:00:00
#SBATCH --mem=80G
export JOB=4LG_2x2_AA_opt_HSESOL3C_optimized_charge+potential
