#!/bin/bash --login
#SBATCH -J FeCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o FeCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=FeCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
