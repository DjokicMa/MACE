#!/bin/bash --login
#SBATCH -J PandaNiCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o PandaNiCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=PandaNiCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
