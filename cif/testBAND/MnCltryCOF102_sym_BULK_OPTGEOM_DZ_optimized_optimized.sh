#!/bin/bash --login
#SBATCH -J MnCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o MnCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=MnCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
