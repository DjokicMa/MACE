#!/bin/bash --login
#SBATCH -J PtExtPandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o PtExtPandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=PtExtPandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
