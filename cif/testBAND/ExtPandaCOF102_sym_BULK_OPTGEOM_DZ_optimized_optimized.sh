#!/bin/bash --login
#SBATCH -J ExtPandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o ExtPandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=ExtPandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
