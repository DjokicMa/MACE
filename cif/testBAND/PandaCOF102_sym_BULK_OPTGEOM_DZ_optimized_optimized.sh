#!/bin/bash --login
#SBATCH -J PandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o PandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=PandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
