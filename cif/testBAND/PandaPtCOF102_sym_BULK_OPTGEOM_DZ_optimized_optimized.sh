#!/bin/bash --login
#SBATCH -J PandaPtCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o PandaPtCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=PandaPtCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
