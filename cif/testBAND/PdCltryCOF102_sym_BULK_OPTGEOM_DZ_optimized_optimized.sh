#!/bin/bash --login
#SBATCH -J PdCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o PdCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=PdCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
