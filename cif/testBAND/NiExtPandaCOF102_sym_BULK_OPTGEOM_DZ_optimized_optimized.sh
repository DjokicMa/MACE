#!/bin/bash --login
#SBATCH -J NiExtPandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o NiExtPandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=NiExtPandaCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
