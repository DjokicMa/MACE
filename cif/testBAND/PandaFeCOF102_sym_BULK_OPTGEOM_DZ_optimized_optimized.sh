#!/bin/bash --login
#SBATCH -J PandaFeCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o PandaFeCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=PandaFeCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
