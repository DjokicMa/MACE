#!/bin/bash --login
#SBATCH -J PtCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o PtCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=PtCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
