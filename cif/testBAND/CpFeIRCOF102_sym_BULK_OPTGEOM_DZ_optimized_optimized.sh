#!/bin/bash --login
#SBATCH -J CpFeIRCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o CpFeIRCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=CpFeIRCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
