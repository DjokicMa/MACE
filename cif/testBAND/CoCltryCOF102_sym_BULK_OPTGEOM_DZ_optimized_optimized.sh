#!/bin/bash --login
#SBATCH -J CoCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o CoCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=CoCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
