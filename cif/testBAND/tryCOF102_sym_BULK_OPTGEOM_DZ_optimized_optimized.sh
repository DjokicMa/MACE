#!/bin/bash --login
#SBATCH -J tryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o tryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=tryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
