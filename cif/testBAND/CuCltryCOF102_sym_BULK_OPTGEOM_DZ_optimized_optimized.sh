#!/bin/bash --login
#SBATCH -J CuCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
#SBATCH -o CuCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized-%J.o
...
export JOB=CuCltryCOF102_sym_BULK_OPTGEOM_DZ_optimized_optimized
