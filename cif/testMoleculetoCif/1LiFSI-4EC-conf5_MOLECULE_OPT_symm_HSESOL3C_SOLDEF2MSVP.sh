#!/bin/bash --login
#SBATCH -J 1LiFSI-4EC-conf5_MOLECULE_OPT_symm_HSESOL3C_SOLDEF2MSVP
#SBATCH -o 1LiFSI-4EC-conf5_MOLECULE_OPT_symm_HSESOL3C_SOLDEF2MSVP-%J.o
...
export JOB=1LiFSI-4EC-conf5_MOLECULE_OPT_symm_HSESOL3C_SOLDEF2MSVP
