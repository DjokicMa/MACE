#!/bin/bash --login
#SBATCH -J Suflolane_MOLECULE_OPT_symm_HSESOL3C_SOLDEF2MSVP
#SBATCH -o Suflolane_MOLECULE_OPT_symm_HSESOL3C_SOLDEF2MSVP-%J.o
...
export JOB=Suflolane_MOLECULE_OPT_symm_HSESOL3C_SOLDEF2MSVP
