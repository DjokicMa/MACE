#!/bin/bash
#SBATCH -J MSUCOF-4-CoCp_BULK_OPTGEOM_DZ_optimized
#SBATCH -o MSUCOF-4-CoCp_BULK_OPTGEOM_DZ_optimized-%J.o
...
export JOB=MSUCOF-4-CoCp_BULK_OPTGEOM_DZ_optimized
