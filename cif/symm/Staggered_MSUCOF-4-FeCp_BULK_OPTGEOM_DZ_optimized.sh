#!/bin/bash
#SBATCH -J Staggered_MSUCOF-4-FeCp_BULK_OPTGEOM_DZ_optimized
#SBATCH -o Staggered_MSUCOF-4-FeCp_BULK_OPTGEOM_DZ_optimized-%J.o
...
export JOB=Staggered_MSUCOF-4-FeCp_BULK_OPTGEOM_DZ_optimized
